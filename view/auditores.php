  ...
  <nav class="main-header navbar navbar-expand-md main-header navbar navbar-expand navbar-dark navbar-lightblue">
    <div class="container">
      <a href="" class="navbar-brand">       
        <span class="brand-text font-weight-light"><b> <i class="fas fa-user-tag"></i> Audotores </b></span>
      </a>
...
$stmt2 = Conexion::conectar()->prepare("SELECT * FROM usuarios  WHERE  level = 21 and level0 = 1");
$stmt2 -> execute();
            ...
            <div class="modal-body"> 
				<div class="form-group row">
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input id="modalUser" type="text" class="form-control" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input id="modalFName" type="text" class="form-control" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input id="modalLName" type="text" class="form-control" />
                    </div>
                  </div>			
            </div>
      ...
      <div class="modal-content">
            ...
            <div class="modal-body"> 
				<div class="form-group row">
                    <label class="col-sm-2 col-form-label">Código: </label>
                    <div class="col-sm-10">
                       <input id="modalCodeEdit" type="text" class="form-control" />
                    </div>
                  </div>
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Usuario: </label>
                    <div class="col-sm-10">
                       <input id="modalUserEdit" type="text" class="form-control" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nombre: </label>
                    <div class="col-sm-10">
                       <input id="modalFNameEdit" type="text" class="form-control" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Apellido: </label>
                    <div class="col-sm-10">
                       <input id="modalLNameEdit" type="text" class="form-control" />
                    </div>
                  </div>	
            </div>
            <div class="modal-footer justify-content-between">
...
$('.assetsList').on('click','button.itemEdit',function(){
	$('#modalCodeEdit').val($(this).attr('codigo'));
	$('#modalUserEdit').val($(this).attr('usuario'))
	$('#modalFNameEdit').val($(this).attr('nombre'));
	$('#modalLNameEdit').val($(this).attr('apellido'));
	
	$('#triggerModalEdit').click();
});

$('#saveItem').click(function(){
$.getJSON('model/auditor_incertar.php',{
		codigo:   $('#modalCode').val(),
		usuario:  $('#modalUser').val(),
		nombre:   $('#modalFName').val(),
		apellido: $('#modalLName').val()
	 },function(data){
		switch(data['ok']){
