  ...
  <nav class="main-header navbar navbar-expand-md main-header navbar navbar-expand navbar-dark navbar-lightblue">
    <div class="container">
      <a href="" class="navbar-brand">       
        <span class="brand-text font-weight-light"><b> <i class="fas fa-users"></i> Usuarios </b></span>
      </a>
...
$stmt2 = Conexion::conectar()->prepare("SELECT * FROM usuarios  WHERE  level = 20 OR level = 500");
$stmt2 -> execute();
...
$.getJSON('model/usuario_incertar.php',{
